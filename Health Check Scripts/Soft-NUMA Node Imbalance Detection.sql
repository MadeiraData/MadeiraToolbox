/*
====================================
Soft-NUMA Node Imbalance Detection
====================================
Author: Eitan Blumin
Date: 2021-06-01
Description:
	This script outputs data about the current load on each Soft-NUMA node.
	Output Resultset:
...
(
	SELECT n.memory_node_id, nodes.node_id
	...
	GROUP BY n.memory_node_id, nodes.node_id, load_type
)
SELECT *
...
FROM memory_nodes
ORDER BY load_type, memory_node_id, node_id
