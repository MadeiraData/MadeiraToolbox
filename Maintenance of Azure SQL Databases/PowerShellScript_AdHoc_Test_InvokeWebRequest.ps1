...
$UserName = 'adf-demo-eric' #$Request.Body.UserName # <============ Will be defined in the ADF settings / body
$Password = 'AzureDataFactory1!' #$Request.Body.Password # <============ Will be defined in the ADF settings / body
