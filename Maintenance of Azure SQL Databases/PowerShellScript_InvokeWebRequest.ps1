...
$Query = Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/MadeiraData/MadeiraToolbox/master/Maintenance%20of%20Azure%20SQL%20Databases/DropTableTest567.sql' -UseBasicParsing 
